...
While not explicitly mentioned within the phd2mm v1.3.1 app itself, this application is licensed under the GNU General Public License v3. 
...
<summary> Click this text to show or hide some screenshots of phd2mm app!</summary>
   ...
   Some images show v1.3, but it's similar to v1.3.1. Only big difference is Category column options is now limited to the Item column value. </br>
...
You can now choose any mod you want to save in the profile by: </br>
...
"Mods not used in the profile" then clicking the "Add Selected Mod" button or; </br>
-Simply double left mouse button click either the leftmost box or the mod name. </br>
...
"Mods used in the profile" then clicking the "Remove Selected Mod" button or; </br>
-Simply double left mouse button click either the leftmost box or the mod name. </br>
